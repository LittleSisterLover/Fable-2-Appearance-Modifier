...
Drag and drop the "data" folder from the mod's download into your game folder. If you opted not to back this up "dir.manifest" it will ask to overwrite it, be sure to allow this.
